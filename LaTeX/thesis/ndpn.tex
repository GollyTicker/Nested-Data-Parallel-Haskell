...
AArr {
  ...
  \subsection{SortP}
    ...
    the workload of its vectorization were expected to be enourmous (on top of the all the other work).
    Retrospectively, the thesis inline and expose the internals of \c{sortP} in \ndpv.
