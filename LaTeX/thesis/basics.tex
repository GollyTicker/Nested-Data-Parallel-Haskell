...
\section{Nested Data Parallelism}
  ...
  \subsection{Vectorization}
    ...
    \subsubsection{Type dependent representation}
      ...
      be implemented equally. The subarray could be of different size.
      ...
      to arrays of integers. Pointers however are undesireable, since they
...
array = AArr {
  ...
  lengths = [# 3,2,0,1 #]
      ...
      All structucal information is divied into two arrays of integers.
...
\section{Parallel Complexity Measures}
  ...
  The work and depth of \c{mapP} embodies the idea, that both are the sum or maximum of the subexpressions.
...
\section{\algo}
  ...
  \subsection{Algorithm}
    To describe the image transformation $ hbalance: Image \rightarrow Image$ a few definitions are nesessary:
